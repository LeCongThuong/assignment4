...
class Gaussians:
    ...
    def compute_cov_2D(
        ...
        cov_3D = self.compute_cov_3D(quats=quats, scales=scales)# None  # (N, 3, 3)
...
class Scene:
    ...
    def compute_alphas(self, opacities, means_2D, cov_2D, img_size):
        ...
        ### YOUR CODE HERE ###
        # HINT: Can you find a function in this file that can help?
        power = self.gaussians.evaluate_gaussian_2D(points_2D, means_2D, cov_2D_inverse)#None  # (N, H*W)
    ...
    def splat(
        ...
        ### YOUR CODE HERE ###
        # HINT: Can you find a function in this file that can help?
        means_2D = self.gaussians.compute_means_2D(means_3D=means_3D, camera=camera) #None  # (N, 2)

        ### YOUR CODE HERE ###
        # HINT: Can you find a function in this file that can help?
        cov_2D = self.gaussians.compute_cov_2D(means_3D, quats, scales, camera, img_size) #None  # (N, 2, 2)

        # Step 2: Compute alpha maps for each gaussian

        ### YOUR CODE HERE ###
        # HINT: Can you find a function in this file that can help?
        alphas = self.compute_alphas(opacities, means_2D, cov_2D, img_size) #None  # (N, H, W)

        # Step 3: Compute transmittance maps for each gaussian

        ### YOUR CODE HERE ###
        # HINT: Can you find a function in this file that can help?
        transmittance = self.compute_transmittance(alphas, start_transmittance=start_transmittance)  # (N, H, W)
        ...
        ### YOUR CODE HERE ###
        # HINT: Refer to README for a relevant equation
        image = torch.sum(colours*alphas*transmittance, dim=0) #None  # (H, W, 3)
